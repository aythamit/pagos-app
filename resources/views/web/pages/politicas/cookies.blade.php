...
@section('meta-description','Cookies policy of the Alomran website.')
...
@section('content')
    <section id="politicas">
        ...
        <div class="container">
            ...
            <h2>What types of cookies does alomranunited.com use?</h2>
            ...
            <p>When you navigate through alomranunited.com the following cookies may be installed on your device:</p>
